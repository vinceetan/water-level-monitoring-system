...
export default function CommunityDashboard() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-auto lg:h-[calc(100vh-4rem)] gap-4 font-sans pb-24 lg:pb-0">
      ...
      <div className="w-auto self-stretch mx-1 lg:mx-0 lg:w-1/2 relative flex flex-col justify-between text-white px-4 py-4 md:px-8 md:py-6 overflow-hidden z-10 min-h-[500px] rounded-3xl shadow-2xl">
        {/* Top bar */}
